...
int main()
{
	...
	// draw mandelbrot: (uncomment exactly one)
		...
		//naivMandelbrot(image, log2limit, bottomLeftX, bottomLeftY, sizeX, sizeY);	
		//naivMultThreadMandelbort(image, log2limit, bottomLeftX, bottomLeftY, sizeX, sizeY);	
		//cpuOptMandelbrot(image, log2limit, bottomLeftX, bottomLeftY, sizeX, sizeY);	
		cpuOptMultThreadMandelbrot(image, log2limit, bottomLeftX, bottomLeftY, sizeX, sizeY);	
